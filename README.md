...
This includes:
- setup for running Red's [current stable installation instructions](https://docs.discord.red/en/stable/install_guides/index.html) daily (`daily_install_tests_stable.yaml` workflow),
- setup for running Red's [installation instructions from `V3/develop` branch](https://docs.discord.red/en/latest/install_guides/index.html) daily (`daily_install_tests_dev.yaml` workflow),
